...
const Carousel = React.memo(({
  ...
  const modBySlidesLength = useCallback((idx) => {
  ...
  const getShortestDirection = useCallback((from, to) => {
    if (from > to) {
  ...
  }, [goToSlide, index, slides.length, getShortestDirection, modBySlidesLength]);

  const clampOffsetRadius = useCallback((offset) => {
